...
var favoriteBook = Book(title: "Ready Player One", author: "Ernest Cline", pages: 374, price: 29.40)
print("My favorite book is \"\(favoriteBook.title)\" by \(favoriteBook.author). It has \(favoriteBook.pages) pages and costs about $\(favoriteBook.price) USD.")
...
struct Laptop {
    ...
    var repairCout: Int = 0
    var yearPurchased: Int
}

var laptopOne = Laptop(yearPurchased: 2020)
