...
struct User {
    ...
    static var currentUser = User(userName: "Jose1", email: "posadaJ9837@durhamtech.edu", age: 30)
 ...
 */
User.currentUser.logIn(userName: "Jose1", email: "posadaJ9837@durhamtech.edu", age: 30)
