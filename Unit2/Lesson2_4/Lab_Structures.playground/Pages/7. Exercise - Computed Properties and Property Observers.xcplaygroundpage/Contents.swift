...
let firstRectangle = Rectangle(width: 5, height: 10)
print(firstRectangle.area)
    ...
    var heightInCentimeters: Double{
        ...
        didSet{
            if heightInCentimeters > oldValue {
                print("Added \(heightInCentimeters - oldValue) inches")
            }
        }
    }
...
var newHeight = Height(heightInInches: 74)
print(newHeight.heightInCentimeters)
newHeight.heightInInches = 75
print(newHeight.heightInCentimeters)
