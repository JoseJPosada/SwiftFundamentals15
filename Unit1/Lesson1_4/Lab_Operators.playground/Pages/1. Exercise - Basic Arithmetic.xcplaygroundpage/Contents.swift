...
print(3)
let intergerDivisionResults = 10 / 3
print(intergerDivisionResults)
...
print("It allows for the decimal of the division.")
/*:
...
print(even % 2)
print(odd % 2)
print("Odd numbers will always have a remainder if 1 and even numbers is always have a remainder of 0")
/*:
